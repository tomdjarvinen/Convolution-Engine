...
HD_PWD='C:/Users/saina/Desktop/SeniorDesign/Top_Module/Top_Module.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopLevel_Convolution.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopLevel_Convolution.tcl

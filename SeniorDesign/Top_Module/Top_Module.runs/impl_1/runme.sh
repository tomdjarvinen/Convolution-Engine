...
HD_PWD='C:/Users/saina/Desktop/SeniorDesign/Top_Module/Top_Module.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopLevel_Convolution.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopLevel_Convolution.tcl -notrace

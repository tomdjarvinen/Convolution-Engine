...
HD_PWD='H:/Desktop/SeniorDesign/Final Code/Final_FifoBuffers/Fifo_Buffers.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FifoTesting.vdi -applog -m64 -messageDb vivado.pb -mode batch -source FifoTesting.tcl -notrace

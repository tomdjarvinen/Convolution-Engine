...
HD_PWD='H:/Desktop/SeniorDesign/Final Code/Final_FifoBuffers/Fifo_Buffers.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FifoTesting.vds -m64 -mode batch -messageDb vivado.pb -notrace -source FifoTesting.tcl
